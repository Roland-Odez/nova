  ...
  return (
    <section className="bg-black pb-52">
        <div className="container mx-auto px-3 md:px-10">
            ...
            <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">Immerse yourslef in a rich and ever-expanding universe where a vibrant array of products converge into an interconnected overlay experience on your world.</p>
            </div>
            ...
            <div className="grid h-[135vh] gird-cols-2 grid-rows-3 gap-7">
                ...
                <BentoTilt className="bento-tilt_1 row-span-1 me-14 md:!col-start-2 md:!col-span-1 md:me-0">
                    <BentoCard
